...
db_items = {
    1: {"id": 1, "name": "Морозиво", "description": "Дуже холодне", "price": 32.0},
    2: {"id": 2, "name": "Лимонад", "description": "Освіжаючий напій", "price": 67.0},
    3: {"id": 3, "name": "Піцца", "description": "Не веганська", "price": 101.0},
}
item_id_counter = 4
@app.post("/token")
...
async def create_item(
    ...
    return {"message": "Річ успішно додано", "item": new_item}
...
async def delete_item(
    ...
    return {"message": f"Предмет '{deleted_item['name']}' видалено", "deleted_item": deleted_item}
